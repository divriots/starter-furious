...
import { provideDesignSystem, getButton, getTab, getTabPanel, getTabs } from '@divriots/starter-furious';
...
export const defaultStory = () => html`
  <fs-tabs>
    ...
    <fs-tab slot="tab">Tab two</fs-tab>
    <fs-tab slot="tab">Tab three</fs-tab>
    <fs-tab-panel slot="tabpanel">Tab panel 1</fs-tab-panel>
    <fs-tab-panel slot="tabpanel">Tab panel 2</fs-tab-panel>
    <fs-tab-panel slot="tabpanel">Tab panel 3</fs-tab-panel>
  </fs-tabs>
`;
...
export const withStartAndEndStory = () => html`
  <fs-tabs>
    <fs-button appearance="stealth" slot="start">
